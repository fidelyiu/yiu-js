...
function _treeGetFilterBySearch(treeData: Array<any>, scFunc: TreeSearchFunc, currentLevel: number, opt: TreeFilterOption): Array<any> {
...
export default function treeGetFilterBySearch(treeData: Array<any>, scFunc: TreeSearchFunc, opt: TreeFilterOption): Array<any> {
    return _treeGetFilterBySearch(treeData, scFunc, 0, opt);
}
